...
export function NotFound() {
  useEffect( () => {
    document.title = `Página não encontrada - ${PROJECT_NAME}`;
  }, [] );
  return (
    <MainTemplate >
      <Container >
        <GenericHtml >
          ...
          <p >
            ...
            segurança para a <RouterLink href={ROUTES.HOME.path}>página
            principal</RouterLink > ou{' '}
            <RouterLink href={ROUTES.HISTORY.path}>para o
              histórico</RouterLink > — ou pode
            ficar por aqui e
